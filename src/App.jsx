      ...
      <main>
        ...
        <div className="containerr-right">
          ...
          <div className="container-ClimaXDay">
            <ClimaforDAY
              dia={"Mañana"}
              imagenPNG={`./img/${current?.list[10]?.weather[0]?.main}.png`}
            ...
            <ClimaforDAY
              ...
              imagenPNG={`./img/${current?.list[18]?.weather[0]?.main}.png`}
            ...
            <ClimaforDAY
              ...
              imagenPNG={`./img/${current?.list[26]?.weather[0]?.main}.png`}
            ...
            <ClimaforDAY
              ...
              imagenPNG={`./img/${current?.list[34]?.weather[0]?.main}.png`}
            ...
            <ClimaforDAY
              ...
              imagenPNG={`./img/${current?.list[38]?.weather[0]?.main}.png`}
